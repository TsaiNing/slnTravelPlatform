...
public partial class dbTravalPlatformContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<RCarInfoView>(entity =>
        {
            ...
            entity.Property(e => e.fCompanyName).HasMaxLength(50);
            entity.Property(e => e.fServicePoint).HasMaxLength(50);
            entity.Property(e => e.fLicensePlateNum).HasMaxLength(50);
            entity.Property(e => e.fImagePath).HasMaxLength(50);
            entity.Property(e => e.fModelName).HasMaxLength(50);
        });
        ...
        modelBuilder.Entity<RCarRentOrderDetailView>(entity =>
        {
            ...
            entity.Property(e => e.fOrderId)
                .IsRequired()
                .HasMaxLength(50);
            entity.Property(e => e.fFromDateTime).HasColumnType("datetime");
            entity.Property(e => e.fLicensePlateNum).HasMaxLength(50);
            entity.Property(e => e.fModelName).HasMaxLength(50);
            entity.Property(e => e.fRentServicePoint).HasMaxLength(50);
            entity.Property(e => e.fRentDateTime).HasColumnType("datetime");
        ...
        modelBuilder.Entity<RCarRentOrderInfoView>(entity =>
        {
            ...
            entity.Property(e => e.fPayment).HasMaxLength(50);
            entity.Property(e => e.fPaymentStatus).HasMaxLength(50);
            entity.Property(e => e.fCoupon_name).HasMaxLength(50);
            entity.Property(e => e.fName).HasMaxLength(50);
            entity.Property(e => e.fOrderDate).HasMaxLength(50);
            entity.Property(e => e.fOrderStatus).HasMaxLength(50);
            entity.Property(e => e.fOrderId)
                .IsRequired()
                .HasMaxLength(50);
            entity.Property(e => e.fTotalPrice).HasColumnType("money");
        });
